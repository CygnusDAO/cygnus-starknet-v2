...
pub struct NewOrbiter {
    ...
    pub albireo_orbiter: cygnus::orbiters::albireo::IAlbireoDispatcher,
    /// The dispatcher for the Deneb orbiter.
    pub deneb_orbiter: cygnus::orbiters::deneb::IDenebDispatcher,
}
...
pub struct NewShuttle {
    ...
    pub borrowable: cygnus::borrowable::IBorrowableDispatcher,
    /// The dispatcher for the collateral component.
    pub collateral: cygnus::collateral::ICollateralDispatcher,
}
