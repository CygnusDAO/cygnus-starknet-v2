...
pub trait IERC6909<TState> {
    ...
    fn balance_of(self: @TState, owner: ContractAddress, id: u128) -> u128;
    ...
    fn allowance(self: @TState, owner: ContractAddress, spender: ContractAddress, id: u128) -> u128;
    ...
    fn transfer(ref self: TState, receiver: ContractAddress, id: u128, amount: u128) -> bool;
    ...
    /// @param amount The amount of the token.
    fn transfer_from(
        ref self: TState, sender: ContractAddress, receiver: ContractAddress, id: u128, amount: u128
    ) -> bool;
    ...
    /// @param id The id of the token.
    /// @param amount The amount of the token.
    fn approve(ref self: TState, spender: ContractAddress, id: u128, amount: u128) -> bool;
...
pub trait IERC6909Camel<TState> {
    ...
    /// @param id The id of the token.
    /// @return The balance of the token.
    fn balanceOf(self: @TState, owner: ContractAddress, id: u128) -> u128;
...
pub trait IERC6909Metadata<TState> {
    ...
    fn name(self: @TState, id: u128) -> ByteArray;

    /// @notice Symbol of a given token.
    /// @param id The id of the token.
    /// @return The symbol of the token.
    fn symbol(self: @TState, id: u128) -> ByteArray;

    /// @notice Decimals of a given token.
    /// @param id The id of the token.
    /// @return The decimals of the token.
    fn decimals(self: @TState, id: u128) -> u8;
}
...
pub trait IERC6909TokenSupply<TState> {
    ...
    fn total_supply(self: @TState, id: u128) -> u128;
}
...
pub trait IERC6909ContentURI<TState> {
    ...
    fn token_uri(self: @TState, id: u128) -> ByteArray;
}
