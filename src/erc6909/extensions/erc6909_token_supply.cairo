...
pub mod ERC6909TokenSupplyComponent {
    ...
    use cygnus::erc6909::ERC6909Component;
    use cygnus::erc6909::interface;
    use starknet::ContractAddress;

    #[storage]
    struct Storage {
        ERC6909TokenSupply_total_supply: LegacyMap<u128, u128>,
    }
    ...
    > of interface::IERC6909TokenSupply<ComponentState<TContractState>> {
        ...
        fn total_supply(self: @ComponentState<TContractState>, id: u128) -> u128 {
